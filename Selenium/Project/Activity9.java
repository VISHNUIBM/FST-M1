...
public class Activity9 {
    ...
    public void Activity9() {
       ...
       WebElement SocialMediaButton = driver.findElement(By.xpath("//a[@href='https://alchemy.hguy.co/lms/courses/social-media-marketing/']"));
        ...
        System.out.println("Strategy Course Status: " +DevelopingStrategyStatus.getText());
        Reporter.log("Strategy Course Status: " + DevelopingStrategyStatus.getText());

        driver.navigate().back();

        WebElement DigitalAdvertising = driver.findElement(By.cssSelector("div.ld-item-list-item:nth-child(2) > div:nth-child(1) > a:nth-child(1)"));
        DigitalAdvertising.click();

        WebElement DigiAdvStatus = driver.findElement(By.cssSelector(".ld-lesson-list-progress"));
        Assert.assertEquals(DigiAdvStatus.getText(),"100% COMPLETE");
        System.out.println("Digital Course Status " + DigiAdvStatus.getText());
        Reporter.log("Digital Course Status : " + DigiAdvStatus.getText());

        driver.navigate().back();

        WebElement InvMarketing = driver.findElement(By.cssSelector("#ld-expand-87 > div:nth-child(1) > a:nth-child(1) > div:nth-child(2)"));
        InvMarketing.click();

        WebElement InvMarketingStatus = driver.findElement(By.cssSelector("div.ld-progress:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)"));
        Assert.assertEquals(InvMarketingStatus.getText(),"100% COMPLETE");
        System.out.println("Inv Marketing Course Status " + InvMarketingStatus.getText());
        Reporter.log("Inv Marketing Status : " + InvMarketingStatus.getText());
