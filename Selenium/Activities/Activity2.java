...
public class Activity2 {
    public static void main(String[] args) {
        ...
        System.out.println("Text in element: Class " + classNameLocator.getText());

        //Find the About Us link using cssSelector()
        WebElement cssLocator = driver.findElement(By.cssSelector(".green"));
        System.out.println("Text in element:  CSS " + cssLocator.getText());

        //Find the About Us link using linkText()
        WebElement linkTextLocator = driver.findElement(By.linkText("About Us"));
        System.out.println("Text in element: TEXT " + linkTextLocator.getText());
